    ...
    <jet-form-section @submitted="updatePassword">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="Mots de passe actuel" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" value="Confirmez mots de passe" />
        ...
        <template #actions>
            <jet-action-message :on="form.recentlySuccessful" class="mr-3 font-bold">
                Sauvegardé.
            </jet-action-message>
