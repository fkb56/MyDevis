    ...
    <jet-action-section>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si nécessaire vous pouvez déconnecter les sessions actives sûr d"autres navigateur. Les sessions récentes seront affiché ici. Si vous pensez que votre compte est compromis, mettez à jour votre mots de passe et déconnecter toutes les sessions actives.
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-sm text-gray-500">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">Ce navigateur</span>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Entrez votre mots de passe pour confirmé la déconnexion des sessions de votre compte.
